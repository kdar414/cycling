#Use the line below in bash to open the container
...
#%%
#This is the test data I am using to test the map matching from uni to Hobson Bay. 
...
coordinates = ';'.join(f"{row['LONGITUDE']},{row['LATITUDE']}" for _, row in gps.iterrows()) #Concerting the coordinates from gps into a string of coordinates seperated by ;
# Set radiuses for each coordinate based on the number of records in the dataframe
length_of_df = len(gps)
radiuses2 = ';'.join(['10'] * length_of_df)

#This is the first 11/12 coordinates from gps (have been using this as a quick test of the code)
...
#radiuses2 = "10;10;10;10;10;10;10;10;10;10;10;10"
...
if response.status_code == 200:
    ...
    if "matchings" in route_data and route_data["matchings"]:
        ...
        m.save("/Users/kad/osrm-docker/route_map_osrm-docker_50.html")
