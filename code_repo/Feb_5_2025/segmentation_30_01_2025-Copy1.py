...
Segment_gdf['seg_group'] = Segment_gdf['seg_uid'].str.split('-').str[0]
Segment_gdf
...
get_graph = GetGraph(
    graph_path='/Users/kad/Desktop/cyclists/Kimberley/segmentation/jupyter/edge_Graph_5_feb.gpkg',  # Ensure it's a file, not a directory
    segment_length=5, 
    segment_method='edge', 
    area_name='allakl', 
