...
list_data = [(174.80568275, -36.8535175)]
...
bbox = {
    'min_x': 174.666448,  # Minimum longitude
    'min_y': -36.958816,  # Minimum latitude
    'max_x': 174.917118,  # Maximum longitude
    'max_y': -36.820116,  # Maximum latitude
...
nx.draw(SEG_GDF_GRAPH_subgraph, with_labels=True, node_size=50, font_size=8)
...
segments_along_track = GetSegsAlongTracks(tracks:dict, graph:nx.Graph, max_pathlength:int=10, remove_duplicates:bool=True, debug=True,
                        filter_isolate_branches:bool=True)
